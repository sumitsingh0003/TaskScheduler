      ...
      if(rows.length>0){
          rows.forEach(async (row)=>{
              try {
                 ...
                 await instance.get(`https://social.web2rise.in/api/send.php?number=91${row.phone}&type=text&message=${message}&instance_id=653A34E7BDD0F&access_token=f03cd8235c4fc75ae2fb4605e0fded50`)
                    .then(async response => {
